  ...
  return (
    <div className="flex flex-col w-full mx-auto lg:max-w-6xl max-w-prose lg:my-12 mt-6 mb-12 px-4">
      <div className={garamond.className}>
        ...
        <TypographyParagraph>
          &ldquo;We&rdquo;, &ldquo;Us&rdquo;, &ldquo;Our&rdquo; are in reference to KCL DND. &ldquo;You&rdquo;,
          &ldquo;Your&rdquo; are in reference to the user.
        </TypographyParagraph>
        <TypographyParagraph>
          By accessing Our services You accept and agree to the following terms and conditions: We give no warranty as
          to the accuracy of the information or guidance for any specific purpose. The information and guidance
          contained on the website does not constitute legal or professional advice.
        </TypographyParagraph>
        <TypographyParagraph>
