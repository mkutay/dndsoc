            ...
            <TableBody>
              {damageSeverityData.map((row, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell className="text-primary font-medium">{row.setback}</TableCell>
                  <TableCell className="text-primary font-medium">{row.dangerous}</TableCell>
                  <TableCell className="text-primary font-medium">{row.deadly}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
            ...
            <TableBody>
              {escapeFactors.map((row, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell className="font-semibold text-primary">{row.effect}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
        ...
        <Tabs defaultValue="urban" className="w-full">
          ...
          <TabsContent value="urban" className="mt-4">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="font-medium w-16">d20</TableHead>
...
function MagicItemEconomy() {
  ...
  const sellingResultsData = [
    ...
    { roll: "91 or higher", result: "A shady buyer offering 1 1/2 x the base price, no questions asked" },
  ];
    ...
    <Card className="justify-start hover:shadow-lg transition-all duration-300 border-2 border-border bg-gradient-to-br from-card to-card/40">
      ...
      <CardContent className="space-y-6">
        <div>
          ...
          <TypographyParagraph className="text-sm italic mt-2">
        ...
        <div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="font-medium">d100 + Mod.</TableHead>
...
function Carousing() {
  ...
  return (
    <Card className="justify-start hover:shadow-lg transition-all duration-300 border-2 border-border bg-gradient-to-br from-card to-card/40">
      <CardHeader>
        <CardTitle className="flex items-center gap-3">
          <DicesIcon className="w-7 h-7 text-primary" />
          Carousing
        </CardTitle>
      </CardHeader>
