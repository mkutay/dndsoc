...
import { GiRunningNinja, GiTrapMask } from "react-icons/gi";
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2">
              <div className="p-3 bg-muted rounded-md text-sm">
                <strong className="text-primary">Mechanical:</strong> Pits, arrow traps, falling blocks, water-filled rooms, whirling blades - depend on physical mechanisms.
              </div>
              <div className="p-3 bg-muted rounded-md text-sm">
                <strong className="text-primary">Magical Device:</strong> Initiate spell effects when activated.
              </div>
              <div className="p-3 bg-muted rounded-md text-sm">
                <strong className="text-primary">Spell Traps:</strong> Spells like glyph of warding and symbol that function as traps.
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm leading-loose">
              ...
              Deadliest traps combine multiple elements. Intelligent monsters often create bypass mechanisms 
              (hidden levers, secret passages) to safely navigate their own traps.
            </p>
          </div>
        </div>
      </CardContent>
...
function ChaseComplications() {
  const urbanComplications = [
    { roll: "1", complication: "A large obstacle such as a horse or cart blocks your way. Make a DC 15 Dexterity (Acrobatics) check to get past the obstacle. On a failed check, the obstacle counts as 10 feet of difficult terrain." },
    { roll: "2", complication: "A crowd blocks your way. Make a DC 10 Strength (Athletics) or Dexterity (Acrobatics) check (your choice) to make your way through the crowd unimpeded. On a failed check, the crowd counts as 10 feet of difficult terrain." },
    { roll: "3", complication: "A large stained-glass window or similar barrier blocks your path. Make a DC 10 Strength saving throw to smash through the barrier and keep going. On a failed save, you bounce off the barrier and fall prone." },
    { roll: "4", complication: "A maze of barrels, crates, or similar obstacles stands in your way. Make a DC 10 Dexterity (Acrobatics) or Intelligence check (your choice) to navigate the maze. On a failed check, the maze counts as 10 feet of difficult terrain." },
    { roll: "5", complication: "The ground beneath your feet is slippery with rain, spilled oil, or some other liquid. Make a DC 10 Dexterity saving throw. On a failed save, you fall prone." },
    { roll: "6", complication: "You come upon a pack of dogs fighting over food. Make a DC 10 Dexterity (Acrobatics) check to get through the pack unimpeded. On a failed check, you are bitten and take 1d4 piercing damage, and the dogs count as 5 feet of difficult terrain." },
    { roll: "7", complication: "You run into a brawl in progress. Make a DC 15 Strength (Athletics), Dexterity (Acrobatics), or Charisma (Intimidation) check (your choice) to get past the brawlers unimpeded. On a failed check, you take 2d4 bludgeoning damage, and the brawlers count as 10 feet of difficult terrain." },
    { roll: "8", complication: "A beggar blocks your way. Make a DC 10 Strength (Athletics), Dexterity (Acrobatics), or Charisma (Intimidation) check (your choice) to slip past the beggar. You succeed automatically if you toss the beggar a coin. On a failed check, the beggar counts as 5 feet of difficult terrain." },
    { roll: "9", complication: "An overzealous guard, (see the Monster Manual for game statistics), mistakes you for someone else. If you move 20 feet or more on your turn, the guard makes an opportunity attack against you with a spear (+3 to hit; 1d6 + 1 piercing damage on a hit)" },
    { roll: "10", complication: "You are forced to make a sharp turn to avoid colliding with something impassable. Make a DC 10 Dexterity saving throw to navigate the turn. On a failed save, you collide with something hard and take 1d4 bludgeoning damage." },
    { roll: "11 — 20", complication: "No complication." },
  ];

  const wildernessComplications = [
    { roll: "1", complication: "Your path takes you through a rough patch of brush. Make a DC 10 Strength (Athletics) or Dexterity (Acrobatics) check (your choice) to get past the brush. On a failed check, the brush counts as 5 feet of difficult terrain." },
    { roll: "2", complication: "Uneven ground threatens to slow your progress. Make a DC 10 Dexterity (Acrobatics) check to navigate the area. On a failed check, the ground counts as 10 feet of difficult terrain." },
    { roll: "3", complication: "You run through a swarm of insects (see the Monster Manual for game statistics, with the DM choosing whichever kind of insects makes the most sense). The swarm makes an opportunity attack against you (+3 to hit; 4d4 piercing damage on a hit)." },
    { roll: "4", complication: "A stream, ravine, or rock bed blocks your path. Make a DC 10 Strength (Athletics) or Dexterity (Acrobatics) check (your choice) to cross the impediment. On a failed check, the impediment counts as 10 feet of difficult terrain." },
    { roll: "5", complication: "Make a DC 10 Constitution saving throw. On a failed save, you are blinded by blowing sand, dirt, ash, snow, or pollen until the end of your turn. While blinded in this way, your speed is halved." },
    { roll: "6", complication: "A sudden drop catches you by surprise. Make a DC 10 Dexterity saving throw to navigate the impediment. On a failed save, you fall 1d4 x 5 feet, taking 1d6 bludgeoning damage per 10 feet fallen as normal, and land prone." },
    { roll: "7", complication: "You blunder into a hunter's snare. Make a DC 15 Dexterity saving throw to avoid it. On a failed save, you are caught in a net and restrained. See chapter 5, \"Equipment,\" of the Player's Handbook for rules on escaping a net." },
    { roll: "8", complication: "You are caught in a stampede of spooked animals. Make a DC 10 Dexterity saving throw. On a failed save, you are knocked about and take 1d4 bludgeoning damage and 1d4 piercing damage." },
    { roll: "9", complication: "Your path takes you near a patch of razorvine. Make a DC 15 Dexterity saving throw or use 10 feet of movement (your choice) to avoid the razorvine. On a failed save, you take 1d10 slashing damage." },
    { roll: "10", complication: "A creature indigenous to the area chases after you. The DM chooses a creature appropriate for the terrain." },
    { roll: "11 — 20", complication: "No complication." },
  ];
...
function Carousing() {
  const carousingResults = [
    { roll: "1 — 10", result: "Jailed 1d4 days on charges of disorderly conduct, disturbing the peace. Pay a fine of 10gp to avoid jail time, or you can try to resist arrest." },
    { roll: "11 — 20", result: "Regain consciousness in a strange place with no memory of how you got there. You have been robbed of 3d6 x 5 gp." },
    { roll: "21 — 30", result: "You make an enemy. This person/organisation is now hostile to you. DM determines offended party, you decide how you offended them." },
    { roll: "31 — 40", result: "Whirlwind romance. 25% the romance ends badly, 50% the romance is ongoing, 25% the romance ends amicably. You determine the identity of the love interest, subject to your DM's approval." },
    { roll: "41 — 80", result: "Modest winnings from gambling. Recuperate your lifestyle expenses for the time spent carousing." },
    { roll: "81 — 90", result: "Modest winnings from gambling. Recuperate your lifestyle expenses for the time spent carousing and gain 1d20 x 4 gp." },
    { roll: "91+", result: "Make a small fortune gambling. Recuperate your lifestyle expenses for the time spent carousing and gain 4d6 x 10 gp." },
  ];
...
function Madness() {
  const shortTermMadness = [
    { roll: "01 — 20", effect: "Character retreats into their own mind and becomes paralysed. Effect ends if they take damage." },
  ...
  const longTermMadness = [
    { roll: "01 — 10", effect: "Compelled to repeat a specific activity over and over, e.g. washing hands, counting coins, praying" },
    ...
    { roll: "46 — 55", effect: "Attached to \"lucky charm\" (person or thing). Disadvantage on all rolls when more than 30' from it." },
  ...
  const indefiniteFlaws = [
    ...
    { roll: "36 — 45", flaw: "Achieving my goal is the only thing of interest to me. I'll ignore all else to pursue it" },
  ...
  return (
    <Card className="justify-start hover:shadow-lg transition-all duration-300 border-2 border-border bg-gradient-to-br from-card to-card/40">
      ...
      <CardContent>
        ...
        <div>
          <h4 className="text-lg font-bold font-quotes mt-4">
            Curing Madness
          </h4>
          <p className="mt-2 leading-loose text-sm">
            A <i>calm emotions spell</i> can suppress the effects of madness, while a <i>lesser restoration spell</i> can rid
            a character of a short-term or long-term madness. Depending on the source of the madness, <i>remove curse</i> or <i>dispel evil</i> might
            also prove effective. A <i>greater restoration spell</i> or more powerful magic is required to rid a character of indefinite madness. 
          </p>
        </div>
      </CardContent>
    </Card>
          ...
          <div className="py-6 md:py-8 px-8 md:px-12 bg-gradient-to-r from-violet-50/50 via-indigo-50/30 to-purple-50/50 dark:from-violet-950/20 dark:via-indigo-950/10 dark:to-purple-950/20 rounded-2xl border border-violet-200/50 dark:border-violet-800/50">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              ...
              <div className="space-y-3 p-4 bg-white/50 dark:bg-black/20 rounded-lg border border-violet-200/30 dark:border-violet-700/30">
                ...
                <ul className="text-sm space-y-1 text-violet-700 dark:text-violet-300">
                  <li>• <strong>Setup:</strong> Initial positioning & threats</li>
                  <li>• <strong>Complication:</strong> New enemies or hazards</li>
                  <li>• <strong>Resolution:</strong> Final push or escape</li>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-violet-700 dark:text-violet-300">
                    Reinforcements arrive • Boss enters second phase • Environment becomes hostile • 
                    Objective changes mid-fight • Ally needs rescue • Time limit imposed
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="font-bold text-violet-800 dark:text-violet-200 flex items-center gap-2 font-quotes text-lg">
                  ...
                  <p className="text-sm text-violet-700 dark:text-violet-300">
                    Add/remove enemies • Adjust HP pools • Change terrain • Introduce complications • 
                    Modify enemy behavior • Offer new options
                  </p>
                </div>
              </div>
            </div>
