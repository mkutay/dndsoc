...
export function FeatureCard({
  ...
  return (
    <div ref={ref}>
      <Card
        className={`group hover:shadow-lg transition-all duration-500 hover:-translate-y-1 hover:border-primary/50 sm:min-h-[350px] md:min-h-[336px] ${
      ...
      >
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl md:text-3xl group-hover:text-primary transition-colors">{title}</CardTitle>
        </CardHeader>
        <CardContent className="text-center">
          <CardDescription className="mb-4 text-base md:text-lg">{description}</CardDescription>
        </CardContent>
