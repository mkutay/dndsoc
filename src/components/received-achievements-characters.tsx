    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-row flex-wrap gap-4 max-w-xl">
        {characters.map((character) => (
          <Link key={character.character_uuid} className="p-4 bg-card text-card-foreground rounded-2xl shadow hover:bg-card/80 transition-colors text-lg w-fit font-quotes" href={`/characters/${character.characters.shortened}`}>
...
const getReceivedAchievementsCharacter = (id: string) => runQuery((supabase) => supabase
